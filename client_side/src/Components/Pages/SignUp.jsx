      ...
      <div className="max-w-4xl mx-auto p-5 md:flex md:items-center md:justify-between">
        <div>
          ...
          <p>
            ...
            <a href="https://www.yelp.com/static?p=tos">Terms of Service</a> and
            acknowledge Yelp’s{" "}
        ...
        <div className="mt-5">
          <form onSubmit={handleSubmit} className="max-w-xs">
            ...
            />
            <p>
              Birthday <span className="text-gray-200">Optional</span>
            </p>
            <input
              type="month"
              name="month"
            ...
            <input
              type="submit"
              value="Sign Up"
              className="flex items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outlin"
            />
          </form>
